...
export const dictionaries = {
  en: {
    ...
    bento: {
     ...
     admin: {
      ...
      autopilotDescription: 'Autonomous blog management agent.',
      autopilotEnable: 'Enable AutoPilot',
      autopilotDisable: 'Disable AutoPilot',
      autopilotRunNow: 'Run Now',
      autopilotInterval: 'Interval (minutes)',
      autopilotMaxPerRun: 'Max posts per run',
      autopilotMaxPerDay: 'Max posts per day',
      autopilotAutoApprove: 'Auto-approve & publish',
      autopilotRss: 'RSS distribution',
      autopilotTwitter: 'Twitter/X',
      autopilotLinkedin: 'LinkedIn',
      autopilotWhatsapp: 'WhatsApp',
      autopilotStatus: 'Status',
      autopilotRuns: 'Recent Runs',
      autopilotPlans: 'Content Plans',
      autopilotNoRuns: 'No runs yet.',
      autopilotNoPlans: 'No plans yet.',
      autopilotApprove: 'Approve & Publish',
      autopilotSkip: 'Skip',
      autopilotRunning: 'Running...',
      autopilotIdle: 'Idle',
      autopilotError: 'Error',
      autopilotNotifications: 'Notifications',
      autopilotEmailNotifications: 'Email Notifications',
      autopilotEnableEmail: 'Enable email notifications',
      autopilotEmailProvider: 'Email provider',
      autopilotRecipients: 'Recipients (comma-separated)',
      autopilotCycleDone: 'Cycle done',
      autopilotCycleError: 'Cycle error',
      autopilotPostPublished: 'Post published',
      autopilotPostFailed: 'Post failed',
      autopilotSocialAccounts: 'Social Accounts',
      autopilotTwitterEnabled: 'Enable Twitter/X posting',
      autopilotLinkedinEnabled: 'Enable LinkedIn posting',
      autopilotWhatsappEnabled: 'Enable WhatsApp posting',
      autopilotSave: 'Save',
      autopilotSaved: 'Settings saved',
      adminNav: 'Admin',
    },
    notFound: {
      title: 'Signal lost',
    ...
    ui: {
      ...
      modelPlaceholderHf: 'mistralai/Mistral-7B-Instruct-v0.3',
    },
    showcase: {
    ...
    blog: {
      ...
      slugAuto: 'auto',
      bulkTagPlaceholder: 'Add tags (comma-separated)',
    },
    contact: {
      title: 'Contact',
      subtitle: 'Have a project in mind or just want to say hello? Drop a message and I will get back to you.',
      nameLabel: 'Name',
      emailLabel: 'Email',
      ...
      errorNotConfigured: 'EmailJS is not configured. Set NEXT_PUBLIC_EMAILJS_* environment variables.',
    },
    faq: {
  ...
  id: {
    ...
    admin: {
      ...
      autopilotTitle: 'AutoPilot',
      autopilotDescription: 'Agen manajemen blog otonom.',
      autopilotEnable: 'Aktifkan AutoPilot',
      autopilotDisable: 'Nonaktifkan AutoPilot',
      autopilotRunNow: 'Jalankan Sekarang',
      autopilotInterval: 'Interval (menit)',
      autopilotMaxPerRun: 'Maks posting per jalankan',
      autopilotMaxPerDay: 'Maks posting per hari',
      autopilotAutoApprove: 'Otomatis setujui & terbitkan',
      autopilotRss: 'Distribusi RSS',
      autopilotTwitter: 'Twitter/X',
      autopilotLinkedin: 'LinkedIn',
      autopilotWhatsapp: 'WhatsApp',
      autopilotStatus: 'Status',
      autopilotRuns: 'Jejak Eksekusi',
      autopilotPlans: 'Rencana Konten',
      autopilotNoRuns: 'Belum ada eksekusi.',
      autopilotNoPlans: 'Belum ada rencana.',
      autopilotApprove: 'Setujui & Terbitkan',
      autopilotSkip: 'Lewati',
      autopilotRunning: 'Menjalankan...',
      autopilotIdle: 'Siaga',
      autopilotError: 'Kesalahan',
      autopilotNotifications: 'Notifikasi',
      autopilotEmailNotifications: 'Notifikasi Email',
      autopilotEnableEmail: 'Aktifkan notifikasi email',
      autopilotEmailProvider: 'Penyedia email',
      autopilotRecipients: 'Penerima (dipisah koma)',
      autopilotCycleDone: 'Siklus selesai',
      autopilotCycleError: 'Siklus gagal',
      autopilotPostPublished: 'Posting diterbitkan',
      autopilotPostFailed: 'Posting gagal',
      autopilotSocialAccounts: 'Akun Sosial',
      autopilotTwitterEnabled: 'Aktifkan posting Twitter/X',
      autopilotLinkedinEnabled: 'Aktifkan posting LinkedIn',
      autopilotWhatsappEnabled: 'Aktifkan posting WhatsApp',
      autopilotSave: 'Simpan',
      autopilotSaved: 'Pengaturan disimpan',
      adminNav: 'Admin',
    },
    notFound: {
      title: 'Sinyal hilang',
    ...
    blog: {
      ...
      slugAuto: 'otomatis',
      bulkTagPlaceholder: 'Tambah tag (dipisah koma)',
    },
    contact: {
      title: 'Kontak',
      subtitle: 'Ada proyek dalam pikiran atau hanya ingin menyapa? Tinggalkan pesan dan saya akan segera membalas.',
      nameLabel: 'Nama',
      emailLabel: 'Email',
      messageLabel: 'Pesan',
      ...
      errorNotConfigured: 'EmailJS tidak dikonfigurasi. Setel variabel lingkungan NEXT_PUBLIC_EMAILJS_*.',
    },
    faq: {
